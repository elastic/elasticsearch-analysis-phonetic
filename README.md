...
In order to install the plugin, simply run: `bin/plugin -install elasticsearch/elasticsearch-analysis-phonetic/2.2.0`.
...
* [2.2.1-SNAPSHOT](https://github.com/elasticsearch/elasticsearch-analysis-phonetic/blob/es-1.2/README.md)
* [2.2.0](https://github.com/elasticsearch/elasticsearch-analysis-phonetic/blob/v2.2.0/README.md)
